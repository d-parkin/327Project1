...
public class StandardNode {
    ...
    static class BroadcastListener extends Thread {
        /**
         * Listens to all incoming messages that are broadcast or directly sent to the IP on port 3000.
         * Responds to received messages with a timestamp and sender information by starting another thread.
         */
    ...
    /**
     * Responds to received broadcast messages with a timestamp and sender information.
     */
    ...
    static class MulticastListener extends Thread {
        ...
        /**
         * Listens to multicast messages on 225.1.1.1:5000. Responds to received messages with a timestamp and sender information.
         */
        ...
        // LOGGING,  nested class to perform the Threading without the need of multiple files
        /**
         * Responds to received multicast messages with a timestamp and sender information.
         */
